...
model = joblib.load("C:/Users/ericr/Downloads/stacking_model.pkl")
file_path = r"C:/Users/ericr/Downloads/sepsis.csv"
df = pd.read_csv(file_path, encoding='utf-8', escapechar='\\')

y = pd.read_csv("C:/Users/ericr/Downloads/thirtyday_expire_flag_labels.csv")
# Load SHAP values
shap_values_rf_all = pd.read_csv("C:/Users/ericr/Downloads/shap_vals_rf_sepsis.csv", index_col=0)
shap_values_rf_test = pd.read_csv("C:/Users/ericr/Downloads/shap_vals_rf_sepsis_X_test.csv", index_col=0)
X_test= pd.read_csv("C:/Users/ericr/Downloads/X_test_sepsis.csv")
...
# Load the JSON file
with open("C:/Users/ericr/Downloads/test_metrics.json", "r") as f:
